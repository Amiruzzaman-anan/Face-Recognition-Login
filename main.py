...
class Dlib_Face_Unlock:
    ...
    def __init__(self):
        try:
            with open(r'C:\Users\anan\PycharmProjects\face_rec\labels.pickle', 'rb') as self.f:
        ...
        if self.labels_ids != self.og_labels:
            ...
            with open(r'CC:\Users\anan\PycharmProjects\face_rec\KnownFace.pickle', 'rb') as self.faces_file:
